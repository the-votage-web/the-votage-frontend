...
function HeroSection() {
  return (
    <div className="min-h-200 relative shrink-0 w-full bg-black overflow-hidden flex flex-col justify-center items-center pt-20" data-name="Hero section">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center flex-1 py-20 w-full max-w-420 mx-auto px-8 xl:px-16 2xl:px-20">
        <Frame19 />
      </div>
    </div>
  );
...
function Frame29() {
  return (
    <div className="content-stretch flex flex-col gap-6 items-start justify-center relative shrink-0 flex-1 max-w-190">
      <Frame31 />
      <Frame28 />
      <Text />
    </div>
...
function Frame42() {
  return (
    <div className="content-stretch flex items-center justify-between gap-12 xl:gap-20 px-8 xl:px-16 2xl:px-20 py-24 relative shrink-0 w-full max-w-420 mx-auto">
      <Frame29 />
      <Frame55 />
    </div>
  );
...
function Frame56() {
  return (
    <div className="bg-white relative z-10 w-full py-24" data-name="Past Conferences">
      <div className="content-stretch flex flex-col gap-8 items-start px-8 xl:px-16 2xl:px-20 relative shrink-0 w-full max-w-420 mx-auto">
        <Frame49 />
        <Frame60 />
        <Frame58 />
      </div>
...
function Volunteer() {
  return (
    <div id="volunteer" className="bg-white relative z-10 w-full scroll-mt-22.5 py-24" data-name="Volunteer">
      <div className="content-stretch flex gap-12 xl:gap-20 items-start justify-between px-8 xl:px-16 2xl:px-20 relative shrink-0 w-full max-w-420 mx-auto">
        <Frame63 />
        <VolunteerForm />
      </div>
    </div>
...
function Frame96() {
  return (
    <div className="content-stretch flex flex-col gap-4 items-start justify-center relative shrink-0 flex-1 max-w-190">
      <Frame97 />
      <Frame98 />
    </div>
  );
...
function Give() {
  return (
    <div id="give" className="bg-linear-to-t from-[#fffaf7] to-[#fff3eb] relative z-10 w-full scroll-mt-22.5 py-24" data-name="Give">
      <div className="content-stretch flex gap-12 xl:gap-20 items-start justify-between px-8 xl:px-16 2xl:px-20 relative shrink-0 w-full max-w-420 mx-auto">
        <Frame96 />
...
function Footer() {
  return (
    <div className="bg-[#010101] relative z-10 w-full pb-8 pt-24" data-name="Footer">
      <div className="content-stretch flex flex-col gap-14 items-start px-8 xl:px-16 2xl:px-20 relative shrink-0 w-full max-w-420 mx-auto">
        <Frame15 />
        <Frame102 />
      </div>
    </div>
